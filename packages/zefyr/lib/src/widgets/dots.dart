...
class ZefyrDots extends LeafRenderObjectWidget {
  ZefyrDots({@required this.node}) : assert(node != null);
  ...
  @override
  void updateRenderObject(BuildContext context, RenderDots renderObject) {
